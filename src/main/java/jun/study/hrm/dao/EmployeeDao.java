...
import jun.study.hrm.dao.provider.EmployeeDynaSqlProvider;
import jun.study.hrm.domain.Employee;
...
import static jun.study.hrm.util.common.HrmConstants.EMPLOYEETABLE;
...
public interface EmployeeDao {
	...
	@Results({
		...
		@Result(column="DEPT_ID",property="dept",
			one=@One(select="jun.study.hrm.dao.DeptDao.selectById",
		fetchType=FetchType.EAGER)),
		@Result(column="JOB_ID",property="job",
			one=@One(select="jun.study.hrm.dao.JobDao.selectById",
		fetchType=FetchType.EAGER))
	})
